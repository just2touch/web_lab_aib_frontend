...
const FadeWrapper = styled.div`
  ...
  box-shadow: 0 0 0 1px orange, 0 0px 20px 6px orange;
`;
...
const FormWrapper = styled(FadeWrapper)`
  width: 320px;
  min-width: 320px;
  height: 132px;
...
function App() {
  const [events, setEvents]=useState([
    {'id':1,'title':'Помыться','description':'Не стоит','date':1702106497 },
    {'id':2,'title':'Убрать дома','description':'Трупы','date':1703106599 },
    {'id':3,'title':'Поесть','description':'PYTHON РАЗРАБОТКА','date':1703110597 },
    {'id':4,'title':'254 ЗАПИСЬ','description':'НА РУКАВЕ','date':1704109597 }
  ]);
